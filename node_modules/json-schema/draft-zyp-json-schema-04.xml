		...
		"href": "comments/?id={id}"
			...
			<section title="Design Considerations">
				...
				<t>
					...
					semantics of the user-server interface, the retrieval of resource
		...
		"properties": {
			"name": {
				"description": "name of the product"
									...
									<postamble>This indicates that the user can query the server for instances that have a specific name.</postamble>
								</figure>
